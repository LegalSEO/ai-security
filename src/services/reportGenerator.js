...
function generateCoverPage(doc, scanResults, pageWidth, pageHeight) {
  ...
  doc.text('AEGIS SECURITY', centerX, 120, { align: 'center' })
  ...
  doc.setFontSize(8)
  doc.setTextColor(...COLORS.gray)
  doc.text('This report is generated by Aegis Security automated scanning tools.', centerX, pageHeight - 25, { align: 'center' })
  doc.text('For questions or support, visit aegissecurity.com', centerX, pageHeight - 20, { align: 'center' })
}
...
function generateCallToAction(doc, pageWidth, pageHeight, margin) {
  ...
  doc.setFont('helvetica', 'normal')
  doc.setTextColor(...COLORS.primary)
  doc.text('www.aegissecurity.com', centerX, yPos, { align: 'center' })

  yPos += 7
  doc.setTextColor(...COLORS.gray)
  doc.text('hello@aegissecurity.com', centerX, yPos, { align: 'center' })
}
